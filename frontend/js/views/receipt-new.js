...
async function mount(root, { actions }) {
      ...
      card('Detail Kunjungan', null, h('div', {},
        ...
        h('div', { class: 'mt-2' },
          field(h('span', {}, 'Diagnosis ', h('span', { class: 'req' }, '*')),
            h('input', { type: 'text', name: 'diagnosis', maxlength: '300', placeholder: 'mis. Pulpitis irreversibel gigi 36' }),
            'Wajib — kwitansi tanpa diagnosis tidak berlaku. Tulis sesuai catatan dokter; kode ICD-10 boleh disertakan.')),
      )),
  ...
  form.addEventListener('submit', async (e) => {
    ...
    const payload = {
      ...
      diagnosis: el('[name=diagnosis]', form).value.trim(),
